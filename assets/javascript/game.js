//establlish array
// var options = "abcdefghijklmnopqurstuvwxyz";
// var userChoice = ;
// var computerChoice = "abcdefghijklmnopqurstuvwxyz"
var wins = 0;
var losses = 0;
var guessesLeft = 9;
var guessesSoFar = 'nothing';

//user chooses one character a-z (I need the user to make a choice)
document.getElementById('guessesSoFar').value
...
// function random_character() {
    var computerChoice = options"abcdefghijklmnopqurstuvwxyz";
    return computerChoice.substr( Math.floor(Math.random() * options
            .length)];
...
//we determine if the user wins, so...
